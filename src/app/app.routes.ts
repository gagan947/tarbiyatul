...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'assignments/edit/:id', loadComponent: () => import('./component/teacher-portal/teacher-create-assignment/teacher-create-assignment.component').then(m => m.TeacherCreateAssignmentComponent) },
